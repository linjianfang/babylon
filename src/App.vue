      ...
      <div class="menu-bar">
          ...
          <ul class="menu-links">
            ...
            <li class="nav-link" @click="groundedit()">
              <a href="#">
                ...
                <span class="text nav-text">产品设计</span>
              </a>
            </li>
        ...
        <div class="bottom-content">
          ...
          <li class="mode">
            ...
            <span class="mode-text text">护眼模式</span>
        ...
        <div class="menu">
          <ul class="menu-links">
            <li class="nav-link">
              ...
              <i class='bx bx-bar-chart-alt-2 icon'></i>
              <span class="text nav-text">产品参数</span>

            </li>

            <li class="nav-link">
              <span class="bx">　宽度：</span>
              <input v-model="width" class="size-input"></input>
            </li>

            <li class="nav-link">
              <span class="bx">　高度：</span>
              <input v-model="height" class="size-input"></input>
            </li>

            <!-- 颜色 -->
            <li class="nav-link">
              <span class="bx">　颜色：　</span>
              <ColorPicker v-model="color" modebar="none"></ColorPicker>
            </li>

            <!-- LOGO -->
            <li class="nav-link" @click="logo1()">
              <a href="#">
                <i class="bx bx-home-alt icon"></i>
                <span class="text nav-text">LOGO 1</span>
              </a>
            </li>

            <li class="nav-link" @click="logo2()">
              <a href="#">
                <i class="bx bx-home-alt icon"></i>
                <span class="text nav-text">LOGO 2</span>
              </a>
            </li>
            <li class="nav-link" @click="logo3()">
              <a href="#">
                <i class="bx bx-home-alt icon"></i>
                <span class="text nav-text">LOGO 3</span>
              </a>
            </li>
            <li class="nav-link" @click="logo4()">
              <a href="#">
                <i class="bx bx-home-alt icon"></i>
                <span class="text nav-text">LOGO 4</span>
              </a>
            </li>
            <li class="nav-link" @click="logo5()">
              <a href="#">
                <i class="bx bx-home-alt icon"></i>
                <span class="text nav-text">LOGO 5</span>
              </a>
            </li>
...
export default {
  ...
  mounted() {
    ...
    //导入模型
    BABYLON.SceneLoader.ImportMeshAsync("", "./", "bag.glb").then((result) => {
      console.log(result)
      var bag = result.meshes[2]
      this.newMaterial = bag.material;
      this.bag = bag;

      var bag_2 = result.meshes[7]
      this.bag_2 = bag_2;

      var logo_1 = result.meshes[1]
      logo_1.isVisible = false;
      this.logo_1 = logo_1;
      var logo_2 = result.meshes[3]
      logo_2.isVisible = false;
      this.logo_2 = logo_2;
      var logo_3 = result.meshes[4]
      logo_3.isVisible = false;
      this.logo_3 = logo_3;
      var logo_4 = result.meshes[5]
      logo_4.isVisible = false;
      this.logo_4 = logo_4;
      var logo_5 = result.meshes[6]
      logo_5.isVisible = false;
      this.logo_5 = logo_5;
    ...
    // material.alpha = texture.hasAlpha;
    ...
    // }, scene);
    // rulerMesh.position.x = 0.04;
    // rulerMesh.position.y = -0.15;
    // //横向尺子长刻度
    ...
    //     points: [tickStart, tickEnd]
    //   }, scene);
    //   tick_cm.position.x = -0.26;
    //   tick_cm.position.y = -0.13;
    // }
    ...
    // }, scene);
    // rulerMesh2.position.x = -0.3; // 调整横向位置，使其看起来更合适
    // rulerMesh2.position.y = 0.2; // 调整纵向位置，将尺子整体下移
    ...
    //     points: [tickStart, tickEnd]
    //   }, scene);
    //   tick2.position.x = -0.25; // 调整横向位置
    //   tick2.position.y = -0.1; // 调整纵向位置，将长刻度放置在合适位置
    // }
    ...
    //     points: [tickStart, tickEnd]
    //   }, scene);
    //   tick2_cm.position.x = -0.28;
    //   tick2_cm.position.y = -0.1;
    // }
  ...
  methods: {
    ...
    logo1() {
      ...
      this.logo_1.isVisible = !this.logo_1.isVisible;
    },
    logo2() {
      console.log("执行了logo_2")
      this.logo_2.isVisible = !this.logo_2.isVisible;
    },
    logo3() {
      console.log("执行了logo_3")
      this.logo_3.isVisible = !this.logo_3.isVisible;
    },
    logo4() {
      console.log("执行了logo_4")
      this.logo_4.isVisible = !this.logo_4.isVisible;
    },
    logo5() {
      console.log("执行了logo_5")
      this.logo_5.isVisible = !this.logo_5.isVisible;
    },
  },
  watch: {
    width(newValue, oldValue) {
      console.log("width:", this.width / 32)
      if (this.width > 15 && this.width < 100) {
        this.bag.scaling = new BABYLON.Vector3(this.width / 32, this.height / 42, 1);
        this.bag.position.x = -0.005 * this.width + 0.16
        this.bag_2.position.x = -0.005 * this.width + 0.16
        console.log("111111:", this.bag.position.x)

      }
    },
    height(newValue, oldValue) {
      console.log("height", this.height / 32)
      if (this.height > 15 && this.height < 100) {
        this.bag.scaling = new BABYLON.Vector3(this.width / 32, this.height / 42, 1);
        this.bag_2.position.y = 0.01 * this.height - 0.28
      }
    },
